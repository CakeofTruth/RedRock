...
<?php
 ...
 if ($result->num_rows > 0) {
  ...
  $selectString = "select Reseller_Ref_ID, End_User_Name, Cust_Telephone, Request_Built, Request_In_Serv, Or_Sooner, Add_To_Existing, Customer_Time_Zone, Order_No from Custmers";
