...
<div id="slider-polaroid-0" class="slider slider-polaroid polaroid no-responsive" style="height:400px;">
	...
	<p>
		With Hosted Voice, Red Rock is delivering a best-in-class phone system that allows you to buy only what you need. We take care of all the details &ndash; phones, equipment, installation,
		training, and ongoing service &ndash; so you can focus on your business. Best of all: we&rsquo;re local &ndash; we&rsquo;re available around the clock to help solve any problems you might have.
	</p>
	</div>
	</div>
	</div>
