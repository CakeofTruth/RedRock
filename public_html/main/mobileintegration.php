...
?>
	...
	<div class= "two-third">
		<p>
		Accession Communicator, Red Rock's app for mobile and desktop enables you to integrate voice, instant messaging, video, and email into a single cross platform user experience.  
		Accession will become the primary means by which your employees communicate. Key benefits include:
		</p>
		<p>
			<ul style="list-style-type:square">
				...
				<li> Integrate with CRM and business productivity tools such Salesforce, Sugar CRM, WebEx, and Google </li>
			</ul>
		</p>
		<p>
			Accession Communicator is fully integrated into our advanced IP voice services network and provides reliable performance and great support. Your sensitive information is safeguarded with our industry 
			standard security and privacy measures.
		</p>
		<p>
		When team members are able to work from anywhere.  Accession Communicator becomes an important part of your business continuity strategy, too.
		</p>
	</div>
	</div>
	</div>
