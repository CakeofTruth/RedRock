<!-- https://www.sendwithus.com/resources/templates/oxygen https://raw.githubusercontent.com/sendwithus/templates/master/templates/oxygen/invoice.html -->
...
<table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%">
  <tr>
    <td align="left" valign="top" width="100%" style="background:repeat-x url('/assets/images/sandtexture6.png') #ffffff;">
      <center>
                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                      <a href=""><img width="137" height="47" src="\assets\images\Redrocklogo.jpg" alt="Red Rock"></a>
                    </td>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Thank you for your order, <?php ($_POST["resellercn"]) ?>!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              We will update you as soon as the status of your order has changed.
            </td>
          </tr>
          <tr>
            <td class="button">
              ...
              <![endif]--><a href="http://www.redrocktelecom.com"
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;
              font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">
              My Account</a></div>
            </td>
          </tr>
          <tr>
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                ...
                                <?php 'End user name: ' . 	test_input($_POST["endusername"]) . '<br><br>' .
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                ...
                                <input type="text" value="<?php echo date('m/d/y');?>"/> <br />
                                <br />
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td class="item-col quantity" style="text-align:right; padding-right: 10px; border-top: 1px solid #cccccc;">
                      <span class="total-space">Non-Recurring Charge</span> <br />
                      <span class="total-space">Monthly Recurring Charge</span>  <br />
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong>Red Rock Telecommunications</strong><br />
              3719 E La Salle St <br />
              Phoenix, AZ, 85040<br /><br />
            </td>
          </tr>
        </table>
      </center>
